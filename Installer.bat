...
ECHO          บ                                บ
ECHO          บ        SurgeCore  5.0.5         บ
ECHO          บ       Database Installer       บ
ECHO          บ                                บ
...
ECHO.
ECHO Your current 5.0.5 database is complete.
ECHO Please check the SurgeCore repository for any world updates "/sql/updates".
ECHO.
ECHO.
ECHO.
ECHO.
